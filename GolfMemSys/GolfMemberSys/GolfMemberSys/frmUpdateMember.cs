...
namespace GolfMemberSys
{
    public partial class frmUpdateMember : Form
    {
        ...
        private void frmUpdateMember_Load(object sender, EventArgs e)
        {
            ...
            while (drType.Read())
            {
                cboUpdateType.Items.Add(drType["TYPEID"].ToString());
            }
            ...
            while (drCounty.Read())
            {
                cboUpdateCounty.Items.Add(drCounty["COUNTY"].ToString());
            }

            connCounty.Close();

            cboUpdateStatus.Items.Add("Active");
            cboUpdateStatus.Items.Add("Inactive");
            cboUpdateStatus.Items.Add("Removed");
